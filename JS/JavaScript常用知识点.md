...
​		7种基本数据类型（存放在栈，占据空间小、大小固定、属于被频繁使用数据）：

​				Undefined：

​					变量声明未初始化 undefined, 变量未声明 underclear 报错

​             	   typeof检测都会显示 undefined

​				Null:

​					typeof null 显示Object , 这是一个悠久BUG（以前32位系统，000开头全是对象，null表示全为零）
...
​	1种引用数据类型（同时存放在栈和堆中，栈存放指针，堆存放实体）

​				Object

​					里面包含function array date 等，js不支持任何创建自定义类型的机制。
...
![img](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="549"></svg>)
...
![img](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1089" height="712"></svg>)





![img](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1092" height="638"></svg>)
...
![img](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="557" height="102"></svg>)
...
![img](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1027" height="315"></svg>)
