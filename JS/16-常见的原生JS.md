...
instanceof可以准确的判断复杂数据类型，但是不能正确判断基本数据类型。(正确判断数据类型请戳：[github.com/YvetteLau/B…](https://github.com/YvetteLau/Blog/blob/master/JS/data-type.js))
...
更多细节请戳: [github.com/YvetteLau/B…](https://github.com/YvetteLau/Blog/blob/master/JS/for.js)
